...
const SalesProofPopup = ({ show, onClose }: { show: boolean; onClose: () => void }) => {
  ...
  const salesMessages = [
    ...
    "✅ Félicité a obtenu l'accès au rapport confidentiel il y a quelques instants",
...
export default function SigiloX() {
  ...
  // Progression de génération du rapport (30 secondes) avec intégration de géolocalisation
  useEffect(() => {
  ...
  const fetchWhatsAppPhoto = async (phone: string) => {
    ...
    try {
      console.log("Enviando requisição para:", phone)
            ...
            >
              ...
              <div className="bg-white py-12 sm:py-16">
                <div className="container mx-auto px-4">
                  ...
                  {/* Section Témoignages - Optimisée pour mobile avec de vrais avatars */}
                  <div className="text-center mb-8 sm:mb-12">
                        ...
                        <div className="flex gap-2 sm:gap-3">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              // Détection automatique du code pays si l'utilisateur le tape
                              if (value.startsWith("+")) {
          ...
          {currentStep === "result" && (
            ...
            >
              <div className="container mx-auto px-4 max-w-lg">
                ...
                {/* Minuteur avec tension renforcée */}
                <Card
                  ...
                  <CardContent className="p-4 sm:p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 p-3 bg-pink-50 rounded-2xl border border-pink-200">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-semibold text-sm text-[#333333]">A matché avec 6 personnes</div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-4 font-medium">Offre à durée limitée seulement.</p>
                </div>
              </div>
            </motion.div>
          )}
                ...
                <div className="w-full max-w-lg">
                  ...
                  <Card className="bg-white rounded-2xl shadow-lg border-0">
                    <CardContent className="p-4 sm:p-8 space-y-6 sm:space-y-8">
                      ...
                      <Button className="w-full py-3 sm:py-4 text-base sm:text-lg font-bold rounded-xl bg-gradient-to-r from-[#FF0066] to-[#FF3333] hover:from-[#FF0066] hover:to-[#FF3333] text-white shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 touch-manipulation">
                        💳 DÉBLOQUER AVEC PAIEMENT SÉCURISÉ
                      </Button>

                      <p className="text-xs sm:text-sm text-gray-500 text-center flex items-center justify-center gap-2 font-medium">
                        <Shield className="w-4 h-4 sm:w-5 sm:h-5" />🔒 Paiement sécurisé avec chiffrement SSL
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  >
                    <CardContent className="p-4 sm:p-6">
                      <div className="flex items-center gap-2 sm:gap-3 mb-3">
                        <AlertTriangle className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 animate-bounce" />
                        <span className="font-bold text-base sm:text-lg">L'OFFRE EXPIRE DANS :</span>
                      </div>
                      <div className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">{formatTime(timeLeft)}</div>
                      <div className="space-y-1 sm:space-y-2 text-xs opacity-90">
                        <p>
                          Après expiration du délai, le rapport sera définitivement supprimé pour des raisons de
                          confidentialité.
                        </p>
                        <p className="font-bold text-yellow-200">Cette offre ne pourra pas être récupérée plus tard.</p>
                      </div>
                    </CardContent>
                  </Card>
                </div>
